...
#include "rtl8192s/r8192SE_def.h"
...
#define DRV_VERSION  "0013.1127.2009"
...
enum RTL819x_PHY_PARAM {
	...
	RTL819X_PHY_MACREG			= 2,		
	RTL819X_PHY_REG				= 3,		
	RTL819X_PHY_REG_1T2R			= 4,		
	RTL819X_PHY_REG_to1T1R		= 5,		
	RTL819X_PHY_REG_to1T2R		= 6,		
	RTL819X_PHY_REG_to2T2R		= 7,		
	RTL819X_PHY_REG_PG			= 8,		
	RTL819X_AGC_TAB				= 9,		
	RTL819X_PHY_RADIO_A			=10,		
	RTL819X_PHY_RADIO_A_1T		=11,		
	RTL819X_PHY_RADIO_A_2T		=12,		
	RTL819X_PHY_RADIO_B			=13,		
	RTL819X_PHY_RADIO_B_GM		=14,		
	RTL819X_PHY_RADIO_C			=15,		
	RTL819X_PHY_RADIO_D			=16,		
	RTL819X_EEPROM_MAP			=17,		
	RTL819X_EFUSE_MAP				=18,		
};
...
bool rtl8192se_check_ht_cap(struct net_device* dev, struct sta_info *sta, struct rtllib_network* net);
#else
#endif
