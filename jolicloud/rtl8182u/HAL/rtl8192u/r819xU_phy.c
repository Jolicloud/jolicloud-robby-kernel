	...
	switch(priv->rf_chip)
	{
		...
		switch( eRFPowerState )
		{
			case eRfOn:
						...
						rtl8192_setBBreg(dev, rOFDM0_TRxPathEnable, 0xf, 0x3);			
						rtl8192_setBBreg(dev, rOFDM1_TRxPathEnable, 0xf, 0x3);			
						rtl8192_setBBreg(dev, rFPGA0_AnalogParameter2, 0x7000, 0x3);	
			...
			case eRfOff:
						...
						rtl8192_setBBreg(dev, rOFDM0_TRxPathEnable, 0xf, 0);			
						rtl8192_setBBreg(dev, rOFDM1_TRxPathEnable, 0xf, 0);			
						rtl8192_setBBreg(dev, rFPGA0_AnalogParameter2, 0x7000, 0x0);	
#endif
					rtl8192_setBBreg(dev, rFPGA0_XA_RFInterfaceOE, BIT4, 0x0);	
