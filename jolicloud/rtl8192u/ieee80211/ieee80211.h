...
#define ieee80211_rx_probe_rq           ieee80211_rx_probe_rq_rsl
...
#define IEEE80211_QUEUE_LIMIT 128
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,20)        
#ifdef RTL8192U
	struct delayed_work update_assoc_sta_info_wq;
#endif
...
#else
#ifdef RTL8192U
	struct work_struct update_assoc_sta_info_wq;
#endif
...
#ifdef ENABLE_IPS
	struct tq_struct ips_leave_wq;
#endif
#ifdef RTL8192U
	struct tq_struct update_assoc_sta_info_wq;
#endif
	...
	u8    (*ieee80211_ap_sec_type)(struct net_device* dev);
...
#endif
#ifdef RTL8192U
	bool (*check_ht_cap)(struct net_device* dev, struct sta_info *sta, struct ieee80211_network* net);
...
#ifdef ENABLE_AMSDU
extern struct sk_buff *AMSDU_Aggregation(struct ieee80211_device *ieee, struct sk_buff_head *pSendList);
extern u8 AMSDU_GetAggregatibleList(struct ieee80211_device *ieee, struct sk_buff *pCurSkb, struct sk_buff_head	*pSendList, u8 queue_index);
#endif
...
extern void ieee80211_rx_mgt(struct ieee80211_device *ieee,
			     struct sk_buff *skb,
			     struct ieee80211_rx_stats *stats);
extern void ieee80211_rx_probe_rq(struct ieee80211_device *ieee, 
                           struct sk_buff *skb);
...
extern void ieee80211_sta_wakeup(struct ieee80211_device *ieee, short nl);
extern void ieee80211_sta_ps_send_pspoll_frame(struct ieee80211_device *ieee);
extern void ieee80211_check_all_nets(struct ieee80211_device *ieee);
extern void ieee80211_start_protocol(struct ieee80211_device *ieee);
extern void ieee80211_stop_protocol(struct ieee80211_device *ieee,bool shutdown);
extern void ieee80211_softmac_start_protocol(struct ieee80211_device *ieee);
extern void ieee80211_softmac_stop_protocol(struct ieee80211_device *ieee,bool shutdown);
...
#ifdef RTL8192U
extern void IbssAgeFunction(struct ieee80211_device *ieee);
extern struct sta_info *GetStaInfo(struct ieee80211_device *ieee, u8 *addr);
#endif
extern u8 HTFilterMCSRate( struct ieee80211_device* ieee, u8* pSupportMCS, u8* pOperateMCS);
extern void HTUseDefaultSetting(struct ieee80211_device* ieee);
#define RT_ASOC_RETRY_LIMIT	5
u8 MgntQuery_TxRateExcludeCCKRates(struct ieee80211_device *ieee);
#if 1
